...
#pragma warning disable 0618
        ...
        SerializedProperty seeThrough, seeThroughOccluderMask, seeThroughOccluderMaskAccurate, seeThroughOccluderThreshold, seeThroughOccluderCheckInterval, seeThroughDepthOffset;
        SerializedProperty seeThroughIntensity, seeThroughTintAlpha, seeThroughTintColor, seeThroughNoise, seeThroughBorder, seeThroughBorderWidth, seeThroughBorderColor, seeThroughNonOverlap;
        ...
        void OnEnable() {
            ...
            seeThroughNonOverlap = serializedObject.FindProperty("seeThroughNonOverlap");
        ...
        public override void OnInspectorGUI() {
            ...
            if (seeThrough.intValue != (int)SeeThroughMode.Never) {
                ...
                EditorGUILayout.PropertyField(seeThroughNonOverlap, new GUIContent("No Overlap"));
            ...
            if (serializedObject.ApplyModifiedProperties() || profileChanged || (Event.current.type == EventType.ValidateCommand &&
