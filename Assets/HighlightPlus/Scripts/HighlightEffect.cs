...
namespace HighlightPlus {
    ...
    public partial class HighlightEffect : MonoBehaviour {
        ...
        [Tooltip("Shows the see-through effect only if the occluder if at this 'offset' distance form the object.")]
        ...
        [Tooltip("Enable only if this object presents flickering geometry due to overdraw.")]
        public bool seeThroughNonOverlap;
                        ...
                        if (rms[k].fxMatSeeThroughInner != null && rms[k].fxMatSeeThroughInner.Length > l) {
                            ...
                            if (fxMat != null) {
                                ...
                                if (seeThroughOccluderMaskAccurate && seeThroughOccluderMask != -1) {
                                    ...
                                    fxMat.SetInt(ShaderParams.SeeThroughStencilPassOp, seeThroughNonOverlap ? (int)StencilOp.Zero: (int)StencilOp.Keep);
                                } else {
                                    ...
                                    fxMat.SetInt(ShaderParams.SeeThroughStencilPassOp, seeThroughNonOverlap ? (int)StencilOp.Replace : (int)StencilOp.Keep);
                                }
                                if (hasTexture) {
                                    Texture texture = mat.mainTexture;
                                    fxMat.mainTexture = texture;
                                ...
                                if (seeThroughDepthOffset > 0) {
                                    fxMat.SetFloat(ShaderParams.SeeThroughDepthOffset, seeThroughDepthOffset);
